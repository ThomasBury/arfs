...
from arfs.association import f_stat_classification_parallel, f_stat_regression_parallel, association_series
...
class MinRedundancyMaxRelevance(SelectorMixin, BaseEstimator):
    ...
    def fit(self, X, y, sample_weight):
        ...
        self.relevance_args = {"X": X, "y": y, "sample_weight": sample_weight}
        ...
        self.support_ = [x in selected_features for x in self.feature_names_in_]
